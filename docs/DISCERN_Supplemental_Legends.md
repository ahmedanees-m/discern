...
**Table S2. The curated published-case benchmark.**
...
**Table S3. Third-party data sources.**
...
**Table S4. Software, tool, and database versions.**
...
Criteria applied zero times carry the reason, in the same three categories Table S6 uses:
